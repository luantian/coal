...
<div>
  <el-form :model="rowData" status-icon :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm" >
    ...
    <el-form-item label="故障开始时间" prop="alarmStartTime">
      <el-col :span="11">
        <el-date-picker type="datetime" placeholder="请选择故障开始时间" v-model="rowData.alarmStartTime" style="width: 100%;" value-format="yyyy-MM-dd HH:mm:ss" editable="false"></el-date-picker>
      </el-col>
    ...
    <el-form-item label="故障结束时间" prop="alarmEndTime">
      <el-col :span="11">
        <el-date-picker type="datetime" placeholder="请选择故障结束时间" v-model="rowData.alarmEndTime" style="width: 100%;" value-format="yyyy-MM-dd HH:mm:ss" editable="false"></el-date-picker>
      </el-col>
