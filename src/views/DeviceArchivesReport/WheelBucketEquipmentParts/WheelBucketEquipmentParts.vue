...
import addForm from "@/views/DeviceArchivesReport/WheelBucketEquipmentParts/AddForm";
import editForm from "@/views/DeviceArchivesReport/WheelBucketEquipmentParts/EditForm";
