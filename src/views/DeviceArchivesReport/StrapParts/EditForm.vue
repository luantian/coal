...
<div style="width: 700px">
  <el-form :model="rowData" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" >
    ...
    <el-form-item label="部件位置" prop="partsLocation">
      <el-input v-model="rowData.partsLocation" placeholder="请输入部件位置"></el-input>
    </el-form-item>
    <el-form-item label="规格型号" prop="specification">
      <el-input v-model="rowData.specification" placeholder="请输入规格型号"></el-input>
    </el-form-item>
    <el-form-item label="技术参数" prop="technicalParam">
      <el-input v-model="rowData.technicalParam" placeholder="技术参数"></el-input>
    </el-form-item>
    <el-form-item label="附件" prop="annex">
      <el-input v-model="rowData.annex" placeholder="请输入附件"></el-input>
    </el-form-item>
    <el-form-item label="数量" prop="quantity">
      <el-input v-model="rowData.quantity" placeholder="请输入数量"></el-input>
    </el-form-item>
    <el-form-item label="备注" prop="remark">
      <el-input v-model="rowData.remark" placeholder="请输入备注"></el-input>
    </el-form-item>
    <el-form-item>
      ...
      methods: {
        async submitForm(formName) {
          this.$refs[formName].validate(async (valid) => {
            if (valid) {
              const {code} = await ArchiveReportModel.editStrapFile(this.rowData)
              console.log()
              if(code === 200){
                this.$message({
                  message: '修改成功',
