...
import addForm from "@/views/DeviceArchivesReport/ReservedLoaderParts/AddForm";
import editForm from "@/views/DeviceArchivesReport/ReservedLoaderParts/EditForm";
